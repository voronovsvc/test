...
<body>
	...
	<div id="container">
		...
		<div id="claim-block">
        	<div class="claim-top">
            	<p>Автомобили в продаже<span>(самостоятельный подбор)</span></p>
     ...
     <div id="content">
     	<div id="catAutoprodazha">
        
        	<div class="advert">
            	<div class="advert-img"></div>
                <div class="advert-name">
                	<a href="">Chevrolet Aveo 2006</a>
                </div>
                <div class="advert-body">
                	<p>Кузов: <span>Седан (цвет: красный)</span></p>
                </div>
                <div class="advert-engine">
                	<p>Двигатель: <span>V 2.5 л., 100 л.с., бензин</span></p>
                </div>
